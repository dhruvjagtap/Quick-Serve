...
const ProviderDrawerContent = ({ navigation }: any) => {
  ...
  return (
    <DrawerContentScrollView contentContainerStyle={styles.container}>
      ...
      <TouchableOpacity style={styles.menuItem} onPress={() => handleNavigate('ProviderHome')}>
        <Icon name="view-dashboard-outline" size={20} style={styles.icon} />
        <Text style={styles.menuText}>Dashboard</Text>
      </TouchableOpacity>

      <TouchableOpacity style={styles.menuItem} onPress={() => handleNavigate('Community')}>
        <Icon name="account-group-outline" size={20} style={styles.icon} />
